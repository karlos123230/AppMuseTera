...
async function middleware(request) {
    ...
    if (isProtectedRoute && !token) {
        ...
        loginUrl.searchParams.set("error", "Voc\xea precisa fazer login para acessar esta funcionalidade.");
